<nav class="main-navigation mdl-navigation mdl-color--blue-500">
    <a class="mdl-navigation__link" href="/"><i class="material-icons" role="presentation">home</i>Dashboard</a>
    <a class="mdl-navigation__link" href="/user/list"><i class="material-icons" role="presentation">people</i>Users</a>
    <a class="mdl-navigation__link" href=""><i class="material-icons" role="presentation">poll</i>Orders</a>
    ...
    <a class="mdl-navigation__link" href="/invitation/list"><i class="material-icons" role="presentation">people</i>Invitations</a>

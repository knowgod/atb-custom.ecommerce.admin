<div class="mdl-layout__drawer">
    <nav class="mdl-navigation">
        ...
        <a id="website-switcher" class="mdl-navigation__link website-switcher">
            <i class="material-icons target" role="presentation">business</i>Nume Products
        ...
        <ul class="mdl-menu mdl-menu--bottom-left mdl-js-menu mdl-js-ripple-effect website-switcher__menu"
            ...
            <li class="mdl-menu__item">Nume Products</li>
            <li class="mdl-menu__item">Beletto Studio</li>
            <li disabled class="mdl-menu__item">Nutika</li>
        </ul>

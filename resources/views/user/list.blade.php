...
@section('content')
    <script>
        ...
        window['gridCollection'].urlBase = 'user'
    </script>
                    ...
                    <table class="mdl-data-table wide-table mdl-data-table--selectable" ng-cloak>
                        ...
                        <tr ng-repeat="item in data.data track by item.id" ng-class="{'is-selected' : rowSelected(item.id)}" ng-cloak>
                            ...
                            <td class="actions">
                                ...
                                <button class="mdl-button mdl-js-button mdl-button--icon mdl-button--colored mdl-button-on-white" ng-click="invokeAction('/user/delete/id/'+item.id, true)">
